...
const ParadaCardiacaBebe1 = () => {
    const navigation = useNavigation();

    useEffect(()=>{speak()},[])

    function speak() {
        var thingToSay = 'A PARADA CARDÍACA EM BEBÊS ACONTECE QUANDO O CORAÇÃO DO BEBÊ PARA DE BATER. E O BEBÊ FICA inconsciente E SEM RESPIRAR. VEJA SE O BEBÊ ESTÁ RESPIRANDO.';
    ...
    function handleMudaTela2(){
        Speech.stop();
        navigation.navigate('ParadaCardiacaBebe2')
    }
    ...
    return(
        ...
        <View style={styles.body}>
          <Image source={require('../../../assets/ParadaCardiacaBebe/q.png')} style = {{ width: 264, height: 165 }}/>
        </View>
...
export default ParadaCardiacaBebe1;