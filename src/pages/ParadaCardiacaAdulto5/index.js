...
const ParadaCardiacaAdulto5 = () => {
    const navigation = useNavigation();

    useEffect(()=>{speak()},[])

    function speak() {
        var thingToSay = 'SE VOCÊ ESTIVER EM ALGUM LUGAR MUITO MOVIMENTADO COMO UM METRÔ, SHOPPING, ESTÁDIO DE FUTEBOL. PEÇA PARA ALGUÉM IR PROCURAR O APARELHO DE CHOQUE E COMECE O ATENDIMENTO.';
    ...
    return(
        ...
        <View style={styles.body}>
          <Image source={require('../../../assets/ParadaCardiacaAdulto/p.png')} style = {{ width: 300, height: 356 }}/>
        </View>
...
export default ParadaCardiacaAdulto5;