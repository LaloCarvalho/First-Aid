...
const ParadaCardiacaAdulto2 = () => {
    const navigation = useNavigation();

    useEffect(()=>{speak()},[])

    function speak() {
        var thingToSay = 'QUANDO ISSO ACONTECE A PESSOA FICA DESMAIADA, SEM RESPIRAR E NÃO ACORDA.';
    ...
    function handleMudaTela1(){
        Speech.stop();
        navigation.navigate('ParadaCardiacaAdulto1')
    }
    ...
    return(
        ...
        <View style={styles.body}>
          <Image source={require('../../../assets/ParadaCardiacaAdulto/y.png')} style = {{ width: 280, height: 219 }}/>
        </View>
...
export default ParadaCardiacaAdulto2;