...
const DesengasgoBebe1 = () => {
    const navigation = useNavigation();

    useEffect(()=>{speak()},[])

    function speak() {
        var thingToSay = 'PRIMEIRO VOCÊ TEM QUE SABER QUANDO O BEBÊ ESTIVER ENGASGADO. O Bebê  pode ficar agitado,  ou sem choro,  ou  com tosse, ou  com rosto  vermelho, ou roncado, ou com a boca roxa.';
    ...
    return(
        ...
        <View style={styles.body}>
          <Image source={require('../../../assets/DesengasgoBebe/h.png')} style = {{ width: 264, height: 356 }}/>
        </View>
...
export default DesengasgoBebe1;