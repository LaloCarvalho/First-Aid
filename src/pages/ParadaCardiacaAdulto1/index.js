...
const ParadaCardiacaAdulto1 = () => {
    const navigation = useNavigation();

    useEffect(()=>{speak()},[])

    function speak() {
        var thingToSay = 'NESTA SESSÃO VOCÊ IRÁ APRENDER SOBRE PARADA CARDÍACA. ISSO ACONTECE QUANDO O CORAÇÂO DA PESSOA PARA DE BATER.';
    ...
    return(
        ...
        <View style={styles.body}>
          <Image source={require('../../../assets/ParadaCardiacaAdulto/u.png')} style = {{ width: 292, height: 356 }}/>
        </View>
...
export default ParadaCardiacaAdulto1;