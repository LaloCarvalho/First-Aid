...
const Sangramento2 = () => {
    ...
    function speak() {
        var thingToSay = 'QUANDO ENCONTRAR O LOCAL DO SANGRAMENTO VOCÊ IRÁ COMPRIMIR NO LOCAL COM ALGUM PANO OU GAZE';
    ...
    function handleMudaTela1(){
        Speech.stop();
        navigation.navigate('Sangramento1')
    }
    ...
    return(
        ...
        <View style={styles.body}>
          <Image source={require('../../../assets/Sangramento/com.png')} style = {{ width: 280, height: 356 }}/>
        </View>
